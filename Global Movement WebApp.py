...
def transport_services():
    print(" Welcome Global Movement App")
...
welcome = input("Do you you want to login as an admin or Register and login as a regular user\n'Yes' to login as an "
                "admin\n'No' to register and login as a regular user\n:")
while True:
    if welcome == "Yes":
        admin_login()
